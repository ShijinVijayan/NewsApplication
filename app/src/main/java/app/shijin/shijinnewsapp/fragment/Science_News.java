...
import static app.shijin.shijinnewsapp.model.Constants.SCIENCE;

public class Science_News extends androidx.fragment.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        Call<NewsArticles> call = request.getCategoryOfHeadlines(COUNTRY, SCIENCE, API_KEY);
