...
import static app.shijin.shijinnewsapp.model.Constants.SOURCES;

public class World_News extends androidx.fragment.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        Call<NewsArticles> call = request.getWorldHeadlines(SOURCES, API_KEY);
