...
public class Top_Headlines_News extends androidx.fragment.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    View view;
    ...
    private void loadJSON() {
        ...
        Call<NewsArticles> call = request.getTopHeadlines(COUNTRY, API_KEY);
