...
import static app.shijin.shijinnewsapp.model.Constants.SPORTS;

public class Sports_News extends androidx.fragment.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        Call<NewsArticles> call = request.getCategoryOfHeadlines(COUNTRY, SPORTS, API_KEY);
