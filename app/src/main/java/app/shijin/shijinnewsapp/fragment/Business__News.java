...
import static app.shijin.shijinnewsapp.model.Constants.BUSINESS;
import static app.shijin.shijinnewsapp.model.Constants.COUNTRY;

public class Business__News extends androidx.fragment.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        Call<NewsArticles> call = request.getCategoryOfHeadlines(COUNTRY, BUSINESS, API_KEY);
