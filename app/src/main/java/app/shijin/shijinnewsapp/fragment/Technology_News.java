...
import static app.shijin.shijinnewsapp.model.Constants.TECHNOLOGY;

public class Technology_News extends androidx.fragment.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        Call<NewsArticles> call = request.getCategoryOfHeadlines(COUNTRY, TECHNOLOGY, API_KEY);
